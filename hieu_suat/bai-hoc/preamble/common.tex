% ============================================================================
%  preamble/common.tex — style dùng chung cho toàn cây deep_learning.
...
\usepackage{xstring}
\expandafter\def\csname repourl@BlenderProc\endcsname{https://github.com/DLR-RM/BlenderProc}
\expandafter\def\csname repourl@BoT-SORT\endcsname{https://github.com/NirAharon/BoT-SORT}
\expandafter\def\csname repourl@ByteTrack\endcsname{https://github.com/ifzhang/ByteTrack}
\expandafter\def\csname repourl@COLMAP\endcsname{https://github.com/colmap/colmap}
\expandafter\def\csname repourl@OpenOOD\endcsname{https://github.com/Jingkang50/OpenOOD}
\expandafter\def\csname repourl@RAFT\endcsname{https://github.com/princeton-vl/RAFT}
\expandafter\def\csname repourl@RobustBench\endcsname{https://github.com/RobustBench/robustbench}
\expandafter\def\csname repourl@TrackEval\endcsname{https://github.com/JonathonLuiten/TrackEval}
\expandafter\def\csname repourl@aim\endcsname{https://github.com/aimhubio/aim}
\expandafter\def\csname repourl@albumentations\endcsname{https://github.com/albumentations-team/albumentations}
\expandafter\def\csname repourl@alphaXiv\endcsname{https://www.alphaxiv.org}
\expandafter\def\csname repourl@arxiv-sanity\endcsname{https://arxiv-sanity-lite.com}
\expandafter\def\csname repourl@bitsandbytes\endcsname{https://github.com/bitsandbytes-foundation/bitsandbytes}
\expandafter\def\csname repourl@clean-fid\endcsname{https://github.com/GaParmar/clean-fid}
\expandafter\def\csname repourl@cleanlab\endcsname{https://github.com/cleanlab/cleanlab}
\expandafter\def\csname repourl@co-tracker\endcsname{https://github.com/facebookresearch/co-tracker}
\expandafter\def\csname repourl@colour-science\endcsname{https://github.com/colour-science/colour}
\expandafter\def\csname repourl@detectron2\endcsname{https://github.com/facebookresearch/detectron2}
\expandafter\def\csname repourl@diffusers\endcsname{https://github.com/huggingface/diffusers}
\expandafter\def\csname repourl@evo\endcsname{https://github.com/MichaelGrupp/evo}
\expandafter\def\csname repourl@faiss\endcsname{https://github.com/facebookresearch/faiss}
\expandafter\def\csname repourl@fiftyone\endcsname{https://github.com/voxel51/fiftyone}
\expandafter\def\csname repourl@flash-attention\endcsname{https://github.com/Dao-AILab/flash-attention}
\expandafter\def\csname repourl@hydra\endcsname{https://github.com/facebookresearch/hydra}
\expandafter\def\csname repourl@k-diffusion\endcsname{https://github.com/crowsonkb/k-diffusion}
\expandafter\def\csname repourl@klein\endcsname{https://github.com/jeremyong/klein}
\expandafter\def\csname repourl@kornia\endcsname{https://github.com/kornia/kornia}
\expandafter\def\csname repourl@lightly-train\endcsname{https://github.com/lightly-ai/lightly}
\expandafter\def\csname repourl@matrixcalculus.org\endcsname{https://www.matrixcalculus.org}
\expandafter\def\csname repourl@micrograd\endcsname{https://github.com/karpathy/micrograd}
\expandafter\def\csname repourl@mlflow\endcsname{https://github.com/mlflow/mlflow}
\expandafter\def\csname repourl@mmdetection\endcsname{https://github.com/open-mmlab/mmdetection}
\expandafter\def\csname repourl@modAL\endcsname{https://github.com/modAL-python/modAL}
\expandafter\def\csname repourl@nnU-Net\endcsname{https://github.com/MIC-DKFZ/nnUNet}
\expandafter\def\csname repourl@nnUNet\endcsname{https://github.com/MIC-DKFZ/nnUNet}
\expandafter\def\csname repourl@opencv\endcsname{https://github.com/opencv/opencv}
\expandafter\def\csname repourl@optuna\endcsname{https://github.com/optuna/optuna}
\expandafter\def\csname repourl@paperswithcode\endcsname{https://paperswithcode.com}
\expandafter\def\csname repourl@peft\endcsname{https://github.com/huggingface/peft}
\expandafter\def\csname repourl@pycocotools\endcsname{https://github.com/ppwwyyxx/cocoapi}
\expandafter\def\csname repourl@rawpy\endcsname{https://github.com/letmaik/rawpy}
\expandafter\def\csname repourl@scikit-learn\endcsname{https://scikit-learn.org}
\expandafter\def\csname repourl@sglang\endcsname{https://github.com/sgl-project/sglang}
\expandafter\def\csname repourl@snorkel\endcsname{https://github.com/snorkel-team/snorkel}
\expandafter\def\csname repourl@sympy\endcsname{https://www.sympy.org}
\expandafter\def\csname repourl@tide\endcsname{https://github.com/dbolya/tide}
\expandafter\def\csname repourl@open_clip\endcsname{https://github.com/mlfoundations/open_clip}
\expandafter\def\csname repourl@timm\endcsname{https://github.com/huggingface/pytorch-image-models}
\expandafter\def\csname repourl@tinygrad\endcsname{https://github.com/tinygrad/tinygrad}
\expandafter\def\csname repourl@transformers\endcsname{https://github.com/huggingface/transformers}
\expandafter\def\csname repourl@ultralytics\endcsname{https://github.com/ultralytics/ultralytics}
\expandafter\def\csname repourl@umap-learn\endcsname{https://github.com/lmcinnes/umap}
\expandafter\def\csname repourl@vllm\endcsname{https://github.com/vllm-project/vllm}
\expandafter\def\csname repourl@voxel51\endcsname{https://github.com/voxel51/fiftyone}
\expandafter\def\csname repourl@wandb\endcsname{https://github.com/wandb/wandb}
\makeatletter
\newcommand{\repo}[2][]{%
  \IfSubStr{#2}{/}%
...
% Mỗi chương kết thúc bằng một mini project gắn với visual SLAM, nối chuỗi từ chương 1 tới 25.
...
\newtcolorbox{duan}[2]{
  ...
  boxed title style={sharp corners=downhill, arc=2pt, boxrule=0pt, left=0.55em, right=0.55em,
                     top=0.15em, bottom=0.15em},
  title={MINI PROJECT SLAM\quad\textperiodcentered\quad #1\quad\textperiodcentered\quad #2},
  before upper={\bmblock{Mini project SLAM}\setlength{\machbase}{\leftskip}}}
\newcommand{\duanrow}[2]{%
  \par\vspace{0.16em}%
...
% ---------- nhãn nguồn của một khẳng định (research-rules.md mục 6.3) ----------
% \nD tác giả ĐO được (có số, có điều kiện)  \nT tác giả TUYÊN BỐ/suy luận, không đo
% \nM TÔI suy ra hoặc tôi ghép từ nhiều nguồn.  Không trộn hai nhãn trong một câu.
\newcommand{\nD}{{\footnotesize\sffamily\bfseries\color{greendark}[Đ]}}
\newcommand{\nT}{{\footnotesize\sffamily\bfseries\color{steel}[T]}}
\newcommand{\nM}{{\footnotesize\sffamily\bfseries\color{accent}[M]}}
