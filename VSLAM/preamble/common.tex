% ============================================================================
%  preamble/common.tex — style dùng chung cho toàn cây VSLAM.
%  Dẫn xuất từ preamble của cây IMU_Fusion (cùng tác giả, cùng quy ước).
...
\usepackage{xstring}
% --- hệ sinh thái Visual SLAM / SfM / localization ---
\expandafter\def\csname repourl@ACE\endcsname{https://github.com/nianticlabs/ace}
\expandafter\def\csname repourl@ALIKED\endcsname{https://github.com/Shiaoming/ALIKED}
\expandafter\def\csname repourl@Basalt\endcsname{https://gitlab.com/VladyslavUsenko/basalt}
...
\expandafter\def\csname repourl@DBoW2\endcsname{https://github.com/dorian3d/DBoW2}
\expandafter\def\csname repourl@DPVO\endcsname{https://github.com/princeton-vl/DPVO}
\expandafter\def\csname repourl@DROID-SLAM\endcsname{https://github.com/princeton-vl/DROID-SLAM}
\expandafter\def\csname repourl@DSAC*\endcsname{https://github.com/vislearn/dsacstar}
\expandafter\def\csname repourl@DSO\endcsname{https://github.com/JakobEngel/dso}
\expandafter\def\csname repourl@DM-VIO\endcsname{https://github.com/lukasvst/dm-vio}
\expandafter\def\csname repourl@DUSt3R\endcsname{https://github.com/naver/dust3r}
\expandafter\def\csname repourl@ElasticFusion\endcsname{https://github.com/mp3guy/ElasticFusion}
\expandafter\def\csname repourl@GLIM\endcsname{https://github.com/koide3/glim}
\expandafter\def\csname repourl@GTSAM\endcsname{https://github.com/borglab/gtsam}
\expandafter\def\csname repourl@HLoc\endcsname{https://github.com/cvg/Hierarchical-Localization}
\expandafter\def\csname repourl@Kalibr\endcsname{https://github.com/ethz-asl/kalibr}
\expandafter\def\csname repourl@Kimera\endcsname{https://github.com/MIT-SPARK/Kimera-VIO}
\expandafter\def\csname repourl@LSD-SLAM\endcsname{https://github.com/tum-vision/lsd_slam}
\expandafter\def\csname repourl@LightGlue\endcsname{https://github.com/cvg/LightGlue}
\expandafter\def\csname repourl@LoFTR\endcsname{https://github.com/zju3dv/LoFTR}
\expandafter\def\csname repourl@MASt3R\endcsname{https://github.com/naver/mast3r}
\expandafter\def\csname repourl@MonoGS\endcsname{https://github.com/muskie82/MonoGS}
\expandafter\def\csname repourl@NICE-SLAM\endcsname{https://github.com/cvg/nice-slam}
\expandafter\def\csname repourl@NetVLAD\endcsname{https://github.com/Relja/netvlad}
\expandafter\def\csname repourl@OKVIS2\endcsname{https://github.com/smartroboticslab/okvis2}
\expandafter\def\csname repourl@ORB-SLAM2\endcsname{https://github.com/raulmur/ORB_SLAM2}
\expandafter\def\csname repourl@ORB-SLAM3\endcsname{https://github.com/UZ-SLAMLab/ORB_SLAM3}
\expandafter\def\csname repourl@OctoMap\endcsname{https://github.com/OctoMap/octomap}
\expandafter\def\csname repourl@OpenCV\endcsname{https://github.com/opencv/opencv}
\expandafter\def\csname repourl@OpenVINS\endcsname{https://github.com/rpng/open_vins}
\expandafter\def\csname repourl@RTAB-Map\endcsname{https://github.com/introlab/rtabmap}
\expandafter\def\csname repourl@SVO-Pro\endcsname{https://github.com/uzh-rpg/rpg_svo_pro_open}
\expandafter\def\csname repourl@SE-Sync\endcsname{https://github.com/david-m-rosen/SE-Sync}
\expandafter\def\csname repourl@SplaTAM\endcsname{https://github.com/spla-tam/SplaTAM}
\expandafter\def\csname repourl@SuperGlue\endcsname{https://github.com/magicleap/SuperGluePretrainedNetwork}
\expandafter\def\csname repourl@SuperPoint\endcsname{https://github.com/magicleap/SuperPointPretrainedNetwork}
\expandafter\def\csname repourl@SymForce\endcsname{https://github.com/symforce-org/symforce}
...
\expandafter\def\csname repourl@Theseus\endcsname{https://github.com/facebookresearch/theseus}
\expandafter\def\csname repourl@VGGT\endcsname{https://github.com/facebookresearch/vggt}
\expandafter\def\csname repourl@VINS-Fusion\endcsname{https://github.com/HKUST-Aerial-Robotics/VINS-Fusion}
\expandafter\def\csname repourl@VINS-Mono\endcsname{https://github.com/HKUST-Aerial-Robotics/VINS-Mono}
\expandafter\def\csname repourl@evo\endcsname{https://github.com/MichaelGrupp/evo}
\expandafter\def\csname repourl@g2o\endcsname{https://github.com/RainerKuemmerle/g2o}
\expandafter\def\csname repourl@maplab\endcsname{https://github.com/ethz-asl/maplab}
\expandafter\def\csname repourl@manif\endcsname{https://github.com/artivis/manif}
\expandafter\def\csname repourl@rpg_trajectory_evaluation\endcsname{https://github.com/uzh-rpg/rpg_trajectory_evaluation}
\makeatletter
\newcommand{\repo}[2][]{%
  \IfSubStr{#2}{/}%
...
% Mỗi chương kết thúc bằng một mini project chạy được trên EuRoC/TUM-RGBD/KITTI, nối chuỗi qua cả cây.
